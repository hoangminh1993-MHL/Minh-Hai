...
const DEFAULT_WORKFLOWS = {
  sales: ['Nhận thông tin', 'Lấy SĐT', 'Tư vấn sơ bộ', 'Báo giá', 'Thương lượng', 'Thành công', 'Thất bại'],
...
const INITIAL_LEADS = [
  ...
  { id: 'lead-3', name: 'Shop Giày Sneaker HN', phone: '0977665221', wechat: 'sneakerhn_vip', valRmb: 8500, valVnd: 29750000, note: 'Khách cần tìm nguồn hàng giày thể thao nhái MLB Quảng Châu chất lượng 1:1.', salesId: 'usr-5', stage: 'consulting', failReason: null, date: '2026-07-05' },
...
function renderFacebookConfig() {
  ...
  if (webhookUrlInput) {
    ...
    if (origin.includes('localhost') || origin.includes('127.0.0.1')) {
      webhookUrlInput.value = 'https://ycwop-14-163-195-61.free.pinggy.net/webhook';
    } else {
...
function renderDashboardCharts() {
  ...
  const stageNames = ['Nhận thông tin', 'Lấy SĐT', 'Tư vấn sơ bộ', 'Báo giá', 'Thương lượng', 'Thành công', 'Thất bại'];
  ...
  crmChartInstance = new Chart(crmCtx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        borderColor: [
          '#3b82f6', '#8b5cf6', '#06b6d4', '#f59e0b', '#f97316', '#10b981', '#ef4444'
        ],
        borderWidth: 1.5,
        borderRadius: 6
      }]
