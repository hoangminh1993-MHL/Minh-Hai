  ...
  if (DATABASE_URL) {
    ...
    try {
      ...
      if (res.rows.length > 0) {
        ...
        if (!dbState || dbState.dbVersion !== '20.79') {
          console.log('Force updating Postgres DB state with clean db.json v20.79...');
