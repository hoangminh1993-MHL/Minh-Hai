  ...
  if (DATABASE_URL) {
    ...
    try {
      ...
      if (res.rows.length > 0) {
        ...
        if (!dbState || dbState.dbVersion !== '20.74') {
          console.log('Force updating Postgres DB state with clean db.json v20.74...');
...
// Force node container restart 20.74