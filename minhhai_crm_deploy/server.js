  ...
  if (DATABASE_URL) {
    ...
    try {
      ...
      if (res.rows.length > 0) {
        ...
        if (!dbState || dbState.dbVersion !== '21.03') {
          console.log('Force updating Postgres DB state with clean db.json v21.03...');
